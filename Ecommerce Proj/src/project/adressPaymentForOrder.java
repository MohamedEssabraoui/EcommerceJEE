...
/**
 * Servlet implementation class adressPaymentForOrder
 */
@WebServlet("/adressPaymentForOrder")
public class adressPaymentForOrder extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adressPaymentForOrder() {
        super();
